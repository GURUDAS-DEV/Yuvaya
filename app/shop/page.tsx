      ...
      <div className="box-border flex w-full flex-col items-start gap-6 sm:gap-8 overflow-visible px-3 sm:px-4 md:px-6 lg:flex-row lg:justify-evenly lg:gap-0 lg:px-[50px]">
        ...
        <div className="box-border flex w-full flex-col items-start justify-start gap-0 overflow-clip rounded-xl sm:rounded-2xl px-3 sm:px-4 md:px-6 pt-4 pb-0 lg:w-[45%] lg:px-[30px] lg:pt-[16px]">
          ...
          <div className="mt-4 sm:mt-5 lg:mt-8 flex w-full flex-col items-start gap-1.5 sm:gap-2 lg:gap-[10px] overflow-clip">
            {features.map((f, i) => (
              <div key={i} className="flex items-start sm:items-center gap-2 sm:gap-2.5 lg:gap-3">
                <svg
                  width="14"
                  height="14"
          ...
          <div className="flex w-full flex-col items-start gap-3 sm:gap-4 mt-4 sm:mt-5 lg:mt-0 lg:h-[138px] lg:justify-between">
            ...
            <div className="flex w-full flex-col gap-2 sm:gap-3 md:gap-4 sm:flex-row">
              <a href="/cart" className="box-border rounded-full border border-gray-400 bg-white px-4 sm:px-6 md:px-8 py-2 sm:py-2.5 md:py-3 font-poppins text-[12px] xs:text-[13px] sm:text-[14px] md:text-[16px] font-medium text-black transition-all hover:border-[#34803c] hover:text-[#34803c] text-center flex-1 sm:flex-auto">
                Add to Cart
              </a>
              <a href="/checkout" className="box-border rounded-full border border-gray-300 bg-[#fffc60] px-4 sm:px-8 md:px-10 py-2 sm:py-2.5 md:py-3 font-poppins text-[12px] xs:text-[13px] sm:text-[14px] md:text-[16px] font-medium text-black transition-all hover:bg-[#f5f014] text-center flex-1 sm:flex-auto">
                Buy Now
              </a>
            </div>
          </div>
