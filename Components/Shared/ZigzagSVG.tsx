...
type ZigzagColor = "green" | "orange" | "white";

interface ZigzagSVGProps {
  color: ZigzagColor;
  className?: string;
...
const COLORS: Record<ZigzagColor, string> = {
  green: "#11731b",
  orange: "#FFAA00",
  white: "#fffdf2",
};
...
const ZigzagSVG: React.FC<ZigzagSVGProps> = ({
  ...
  return (
    <svg
      ...
      overflow="visible"
    >
      <path d={ZIGZAG_PATH} fill={COLORS[color]} />
    </svg>
  );
};
