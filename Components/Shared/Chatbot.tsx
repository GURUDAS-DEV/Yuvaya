  ...
  return (
    <div className="fixed bottom-6 right-6 z-50">
      <div className="flex items-end justify-end">
        <div
          className={`transition-all duration-300 ease-[cubic-bezier(0.4,0,0.2,1)] origin-bottom-right ${
        ...
        <button
          ...
          className={`ml-4 h-14 w-14 rounded-full shadow-[0_8px_30px_rgba(17,115,27,0.3)] transition-all duration-300 flex items-center justify-center ${
            open
